...
<table width='100%' align='center' cellpadding='10'>
    <tr>
        ...
        <?php $nopeserta = $siswa['no_peserta'];
              $no++;
		?>
            <td width='50%'>
                <div style='width:10.4cm;border:1px solid #666;'>
                    <table style="text-align:center; width:100%">
                        <tr>
                            <td style="text-align:left; vertical-align:top">
                                <img src='<?php echo $homeurl . '/foto/almet.png' . '?date=' . time(); ?>' height='60px'>
                            </td>
                    ...
                    <table style="text-align:left; width:100%">
                        ...
                        <tr>
                            ...
                            <td class="ukuran" valign='top'>: <?= $siswa['nama'] ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <div style="padding-top: 12px; padding-left: 30px;" class="ttd"><img src='<?php echo '../../dist/img/ttd.png' . '?date=' . time(); ?> ?>' height='40px'></div>
                            </td>
                        </tr>
                        <tr>
                            <td valign='top'></td>
